...
layui.define(['element', 'layer', 'form'], function (exports) {
    ...
    function login() {
        ...
        loginHtml += '<div class="l-captcha" data-site-key="ff9855aacec570bad53f89ad2cb04e83"></div>';
        loginHtml += '<div class="layui-input-inline pm-login-input">';
        loginHtml += '<input type="text" name="result_response" placeholder="人机验证" value="" autocomplete="off" class="layui-input">';
        loginHtml += '</div>';
        loginHtml += '</div>';
